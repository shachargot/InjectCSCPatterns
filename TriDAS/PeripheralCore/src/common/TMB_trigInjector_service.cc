...
//------------------------------------------------------------------------------
int inquire(std::string test, std::string var, const int &minv, const int &maxv, const int &radix, int &now, std::string config_file_in) {

    //bash-like expansion of config file name
    wordexp_t p;
    wordexp(config_file_in.c_str(), &p, 0);
...
int inquir2(std::string test, std::string var1, std::string var2, const int &minv, 
        const int &maxv, const int &radix, int &num, int &now, std::string config_file_in)
{
...
//------------------------------------------------------------------------------
int inquirl(std::string test, std::string var, const long int &minv, const long int &maxv, const int &radix, long int &now, std::string config_file_in)
{
...
//------------------------------------------------------------------------------
void inquirb(std::string test, std::string var, bool &now, std::string config_file_in) {
...
//------------------------------------------------------------------------------
void inquirs(std::string test, std::string var, std::string &now, std::string config_file_in) {

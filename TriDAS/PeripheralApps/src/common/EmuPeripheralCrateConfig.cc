...
namespace emu {
  ...
  xgi::bind(this,&EmuPeripheralCrateConfig::ODMBLoadFirmwarePoll, "ODMBLoadFirmwarePoll");
            ...
            xgi::bind(this,&EmuPeripheralCrateConfig::TrigInj_InjectALCT, "TrigInj_InjectALCT");
            xgi::bind(this,&EmuPeripheralCrateConfig::TrigInj_InjectCLCT, "TrigInj_InjectCLCT");
            xgi::bind(this,&EmuPeripheralCrateConfig::TrigInj_InjectALCTCLCT, "TrigInj_InjectALCTCLCT");
    ...
    throw (xgi::exception::Exception)
  {
      ...
      this->Default(in,out);
        ...
        void EmuPeripheralCrateConfig::FixCFEB(xgi::Input * in, xgi::Output * out )
            ...
            //
            void EmuPeripheralCrateConfig::TrigInj_InjectALCT(xgi::Input * in, xgi::Output * out ) 
                throw (xgi::exception::Exception) {
                    //
                    cgicc::Cgicc cgi(in);
                    //
                    ...
                    //
                    std::string str_alct_pattern_file_name = "/home/cscdev/pakhotin/Work/2015-03-04_SimulateCSCPatterns/ALCTPattern.ini";
                    std::cout << "ALCT pattern file name = " << str_alct_pattern_file_name << std::endl;
                    if(name != cgi.getElements().end()) {
                        std::cout << "Before getValue" << std::endl;
                        // str_alct_pattern_file_name = cgi["alct_pattern_file_name"]->getValue();
                    ...
                    if (thisTMB) {
                        thisTMB->RedirectOutput(&OutputStringTMBStatus[tmb]);
//                        thisTMB->TrigInj_InjectALCT(str_alct_pattern_file_name);
												// FIXME! There are problems with EmuPeripheralCrateConfig::TrigInj_InjectCLCT function.
												// It is not issued when button pressed. For tests I moved CLCT injector to ALCT
                        thisTMB->TrigInj_InjectCLCT("/home/cscdev/pakhotin/Work/2015-03-04_SimulateCSCPatterns/CLCTPattern_nLayers6_00.txt");
                        thisTMB->RedirectOutput(&std::cout);
                    }
                    //
                    this->TMBUtils(in,out);
            ...
            //
            void EmuPeripheralCrateConfig::TrigInj_InjectCLCT(xgi::Input * in, xgi::Output * out ) 
                throw (xgi::exception::Exception) {
                    std::cout << "TrigInj_InjectCLCT" << std::endl;
                    //
                    cgicc::Cgicc cgi(in);
                    //
                    cgicc::form_iterator name = cgi.getElement("tmb");
                    ...
                    //
                    std::string str_clct_pattern_file_name = "/home/cscdev/pakhotin/Work/2015-03-04_SimulateCSCPatterns/CLCTPattern_nLayers6_00.txt";
                    if(name != cgi.getElements().end()) {
                        // str_clct_pattern_file_name = cgi["clct_pattern_file_name"]->getIntegerValue();
                    }
                    //
                    TMB * thisTMB = tmbVector[tmb];
                    thisTMB->RedirectOutput(&OutputStringTMBStatus[tmb]);
                    std::cout << "str_clct_pattern_file_name = " << str_clct_pattern_file_name << std::endl;
                    thisTMB->TrigInj_InjectCLCT(str_clct_pattern_file_name);
                    thisTMB->RedirectOutput(&std::cout);
                    //
                    this->TMBUtils(in,out);
                    //
            ...
            //
            void EmuPeripheralCrateConfig::TrigInj_InjectALCTCLCT(xgi::Input * in, xgi::Output * out ) 
                throw (xgi::exception::Exception) {
                    std::cout << "TrigInj_InjectALCTCLCT" << std::endl;
                    //
                    cgicc::Cgicc cgi(in);
                    //
                    cgicc::form_iterator name = cgi.getElement("tmb");
...
//                        str_alct_pattern_file_name = cgi["alct_pattern_file_name"]->getValue();
                    ...
                    std::string str_clct_pattern_file_name = "/home/cscdev/pakhotin/Work/2015-03-04_SimulateCSCPatterns/CLCTPattern_nLayers6_00.txt";
                    if(name != cgi.getElements().end()) {
//                        str_clct_pattern_file_name = cgi["clct_pattern_file_name"]->getValue();
                    }
                    //
                    TMB * thisTMB = tmbVector[tmb];
                    thisTMB->RedirectOutput(&OutputStringTMBStatus[tmb]);
//                    thisTMB->TrigInj_InjectALCT(str_alct_pattern_file_name); //FIXME!
                    thisTMB->RedirectOutput(&std::cout);
                    //
                    this->TMBUtils(in,out);
                    //
            ...
            void EmuPeripheralCrateConfig::TriggerTestInjectCLCT(xgi::Input * in, xgi::Output * out ) 
                throw (xgi::exception::Exception) {
                    std::cout << "TriggerTestInjectCLCT" << std::endl;
                    //
                    cgicc::Cgicc cgi(in);
                    //
                    cgicc::form_iterator name = cgi.getElement("tmb");
                ...
                throw (xgi::exception::Exception) {
                    ...
                    *out << cgicc::pre();
                    ...
                    // thisTMB->PrintMPCFramesFromFIFO();  // Print  MPC frames for ONE trigger from FIFO. VME registers: 0x17C, 0x17E, 0x180, 0x182
										//
										thisTMB->DecodeAndPrintMPCFrames(10, true);  // Decode and print MPC frames for both cases:
            ...
            void EmuPeripheralCrateConfig::TMBUtils(xgi::Input * in, xgi::Output * out ) 
                throw (xgi::exception::Exception) {
                    ...
                    *out << cgicc::tr();
                    //
                    *out << cgicc::td().set("ALIGN","left");
                    std::string TrigInj_InjectALCT = toolbox::toString("/%s/TrigInj_InjectALCT",getApplicationDescriptor()->getURN().c_str());
                    *out << cgicc::form().set("method","GET").set("action",TrigInj_InjectALCT) ;
                    ...
                    *out << cgicc::td();
                    //
                    *out << cgicc::td().set("ALIGN","left");
                    *out << "Path to ALCT file:" << std::endl;
                    *out << cgicc::input().set("type","text").set("value","/home/cscdev/pakhotin/Work/2015-03-04_SimulateCSCPatterns/ALCTPattern.ini").set("name","alct_pattern_file_name") << std::endl ;
                    sprintf(buf,"%d",tmb);
                    *out << cgicc::input().set("type","hidden").set("value",buf).set("name","tmb");
                    *out << cgicc::form() << std::endl ;
                    *out << cgicc::td();
                    ...
                    *out << cgicc::tr();
                    //
                    *out << cgicc::td().set("ALIGN","left");
                    std::string TrigInj_InjectCLCT = toolbox::toString("/%s/TrigInj_InjectCLCT",getApplicationDescriptor()->getURN().c_str());
                    *out << cgicc::form().set("method","GET").set("action",TrigInj_InjectCLCT) ;
                    *out << cgicc::input().set("type","submit").set("value","Inject CLCT").set("style","color:green") ;
                    sprintf(buf,"%d",tmb);
                    *out << cgicc::input().set("type","hidden").set("value",buf).set("name","tmb");
                    *out << cgicc::form() << std::endl ;
                    *out << cgicc::td();
                    //
                    *out << cgicc::td().set("ALIGN","left");
                    *out << "Path to CLCT file:" << std::endl;
                    *out << cgicc::input().set("type","text").set("value","/home/cscdev/pakhotin/Work/2015-03-04_SimulateCSCPatterns/CLCTPattern_nLayers6_00.txt").set("name","clct_pattern_file_name") << std::endl ;
                    sprintf(buf,"%d",tmb);
                    *out << cgicc::input().set("type","hidden").set("value",buf).set("name","tmb");
                    *out << cgicc::form() << std::endl ;
                    *out << cgicc::td();
                    ...
                    *out << cgicc::tr();
                    //
                    *out << cgicc::td().set("ALIGN","left");
                    std::string TrigInj_InjectALCTCLCT = toolbox::toString("/%s/TrigInj_InjectALCTCLCT",getApplicationDescriptor()->getURN().c_str());
                    *out << cgicc::form().set("method","GET").set("action",TrigInj_InjectALCTCLCT) ;
                    *out << cgicc::input().set("type","submit").set("value","Inject ALCT+CLCT").set("style","color:green") ;
                    sprintf(buf,"%d",tmb);
                    *out << cgicc::input().set("type","hidden").set("value",buf).set("name","tmb");
                    *out << cgicc::form() << std::endl ;
                    *out << cgicc::td();

...
private:
  ...
  //
  void TrigInj_InjectALCT(xgi::Input * in, xgi::Output * out ) throw (xgi::exception::Exception);
  void TrigInj_InjectCLCT(xgi::Input * in, xgi::Output * out ) throw (xgi::exception::Exception);
  void TrigInj_InjectALCTCLCT(xgi::Input * in, xgi::Output * out ) throw (xgi::exception::Exception);
  //
